                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="{{$texto}}">
                            ...
                            <td><strong>{{$matriculacion->costo}} Bs.</strong></td>
                        </tr>
                    </tbody>
                </table>
                <div class="container-fluid h-100"> 
                    <div class="row w-100 align-items-center">
                        <div class="col text-center">
                            <a class="btn btn-secondary {{$clase}}" href="{{route('pagocom.detallar',$matriculacion->id)}}">Detallar Pagos</a>
                        </div>	
                    </div>
                </div>

...
@if ($estado=="FINALIZADO")
    ...
    <a href="" class="text-secondary ml-2 finalizado" data-toggle="tooltip" data-placement="top" title="Ver este programa"><i class="fas fa-eye fa-2x text-danger"></i></a>
...
@if ($estado=="PRESENTE")
    ...
    <a href="" class="text-secondary ml-2 observacion" data-toggle="tooltip" data-placement="top" title="Agregar Observacion"><i class="fas fa-comment-medical"></i></a>
    <a href="" class="text-secondary ml-2 finalizado" data-toggle="tooltip" data-placement="top" title="Ver este programa"><i class="fas fa-eye fa-2x"></i></a>
@endif
@if ($estado=="INDEFINIDO")
    ...
    <a href="" class="text-secondary ml-2 finalizado" data-toggle="tooltip" data-placement="top" title="Ver este programa"><i class="fas fa-eye fa-2x text-purple"></i></a>

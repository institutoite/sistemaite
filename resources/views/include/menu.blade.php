...
<div class="row">
    <div class="col-6 col-sm-6 col-md-3">
        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">PSA CUP</span>
                <span class="info-box-number"> 10
                    <small>%</small>
                </span>
            </div>
    ...
    <div class="col-6 col-sm-6 col-md-3">
        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">COMPUTACION</span>
                <span class="info-box-number"> 10
                    <small>%</small>
                </span>
            </div>
    ...
    <div class="col-6 col-sm-6 col-md-3">
        ...
        <div class="info-box">
            ...
            <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-street-view"></i></span>

            <div class="info-box-content">
                <span class="info-box-text">VACACIONALES</span>
                <span class="info-box-number"> 10
                    <small>%</small>
                </span>
            </div>
...
<div class="row">
    <div class="col-6 col-sm-6 col-md-3">
        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">UNIVERSIDAD</span>
                <span class="info-box-number"> 10
                    <small>%</small>
                </span>
            </div>
    ...
    <div class="col-6 col-sm-6 col-md-3">
        ...
        <div class="info-box">
            ...
            <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-code"></i></span>
    ...
    <div class="col-6 col-sm-6 col-md-3">
        ...
        <div class="info-box">
            ...
            <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-brain"></i></span>

            <div class="info-box-content">
                <span class="info-box-text">SUPERCEREBRO</span>
                <span class="info-box-number"> 10
                    <small>%</small>
                </span>
            </div>

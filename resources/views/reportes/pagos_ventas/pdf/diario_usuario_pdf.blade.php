...
<head>
    <meta charset="UTF-8">
    <title>Reporte de pagos del usuario</title>
    <style>
...
<body>
    <h1>Reporte de pagos del usuario</h1>
    <div class="meta">Usuario: {{ $usuarioNombre }}</div>
    <div class="meta">Fecha del reporte: {{ $fechaReporte->format('d/m/Y') }}</div>
    <div class="meta">Dia: {{ $diaReporte }}</div>
    <div class="meta">Periodo consultado: {{ $hoy->format('d/m/Y') }}</div>

            ...
            let tablaPagoInscripciones=$('#pagos').DataTable(
                {
                    ...
                    "createdRow": function( row, data, dataIndex ) {
                        ...
                        $('td', row).eq(1).html(data['nombre']+" "+data['apellidop']);
                        $('td', row).eq(4).html("Bs. "+data['monto']);
                        $('td', row).eq(5).html(moment(data['created_at']).format('DD-MM-Y HH:mm'));
                    },
                    "columns": [
                        {data:'id'},
                        {data:'nombre'},
                        ...
                        {data:'created_at'},
                        {
                            ...
                            "data": ["foto",'name'],
                            "render": function (data, type, full, meta) {
                                return "<img class='materialboxed zoomifyuser' src=\"{{URL::to('/')}}/storage/" + data.foto + "\" height=\"50\" title='este es el titulo'/>";
                            },
                            "title": "USER",
                            "orderable": false,

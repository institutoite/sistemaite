            ...
            <div class="card card-outline card-secondary mb-3">
                <div class="card-body py-2">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="forma_pago_efectivo" name="forma_pago" value="EFECTIVO" class="custom-control-input" {{ $formaPagoActual === 'EFECTIVO' ? 'checked' : '' }} required>
                        <label class="custom-control-label" for="forma_pago_efectivo">Efectivo</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="forma_pago_qr" name="forma_pago" value="QR" class="custom-control-input" {{ $formaPagoActual === 'QR' ? 'checked' : '' }} required>
                        <label class="custom-control-label" for="forma_pago_qr">QR</label>
                    </div>
                </div>
            </div>
        </div>

<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
        ...
        <div class="form-floating mb-3 text-gray">
            ...
            <label for="pagocon">Ingrese subtitulo de las materias</label>
        </div>
    </div>
</div> 
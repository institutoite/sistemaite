...
<body class="hidden-bar-wrapper">
  ...
  <div class="page-wrapper">
    ...
    <!-- Page Title -->
      ...
      <section class="page-title" style="background-image: url('{{ asset('assetshome/images/background/robotica.jpg')}}');">
          <div class="auto-container">
        <h2></h2>
          ...
          <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column">
              ...
              <div class="sec-title">
                ...
                <h2>¡Aprende a crear el futuro con el curso de <span>robótica</span> en ITE!</h2>
                <div class="text">Aprende habilidades prácticas mientras te diviertes construyendo y programando robots que pueden moverse, hablar, interactuar y mucho más</div>
              </div>
              <div class="row mt-none-30">
                <div class="col-lg-6">
                  ...
                  <div class="button-box">
                    <a href="https://api.whatsapp.com/send?phone=59171039910&amp;text=Visite su pagina. Quiero mas información de robotica" class="theme-btn btn-style-seven"><span class="txt">Inscribite Hoy..!! <i class="flaticon-next-2"></i></span></a>
                  </div>
                </div>
                <div class="col-lg-6">

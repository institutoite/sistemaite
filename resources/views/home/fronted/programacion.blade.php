...
<div class="page-wrapper">
		...
		<div class="rev_slider_wrapper fullwidthbanner-container"  id="rev_slider_one_wrapper" data-source="gallery">
			<div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
				<ul>
					...
					<li data-transition="fadefromleft" data-description="Slide Description"  data-index="rs-1688" data-slotamount="default" data-thumb="{{ asset('assetshome/images/main-slider/programacionportada.jpg')}}" data-title="Slide Title">
					<img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="{{ asset('assetshome/images/main-slider/programacionportada.jpg')}}"> 
					...
					<li data-transition="fadefromleft" data-description="Slide Description"  data-index="rs-1689" data-slotamount="default" data-thumb="{{ asset('assetshome/images/main-slider/programacionportada.jpg')}}" data-title="Slide Title">
					<img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="{{ asset('assetshome/images/main-slider/programacionportada.jpg')}}">
  ...
  <!-- About Section Two -->
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						<!-- Sec Title -->
						<div class="sec-title">
							<div class="title style-two">Programación y Algoritmos</div>
              <h2>¡<span>Codifica</span> tu camino hacia el futuro!</h2>
							<div class="text">Bienvenidos al curso de Programación de ITE. Estamos
              encantados de tenerte aquí, y estamos seguros de que
              estarás muy contento con el contenido que ofrecemos.
              Durante el curso, te familiarizarás con los fundamentos de
              la programación y aprenderás a usar una variedad de
              lenguajes y herramientas para crear tus propios programas. 
              Durante el curso aprenderás a desarrollar programas en
              lenguajes como C++, Java, Python, JavaScript y muchos
              más. Aprenderás cómo funcionan los conceptos básicos
              como variables, flujos de control, bucles y estructuras de
              datos. También exploraremos conceptos avanzados como
              el diseño orientado a objetos, la programación funcional y
              la creación de interfaces gráficas. <br>
              Finalmente, tendrás la oportunidad de practicar lo que has
              aprendido mediante proyectos prácticos como desarrollar
              un videojuego o una aplicación web. Al completar este
              curso tendrás las habilidades necesarias para desarrollar
              tus propios programas y convertirte en un profesional 
              capacitado para trabajar en el mundo del desarrollo 
              informático. ¡Esperamos que disfrutes este curso! </div>
						</div>
						<!-- Employe Box -->
	...
	<section class="process-section">
        ...
        <div class="sec-title centered">
				  <div class="title style-two">Costos</div>
			  </div>
          ...
          <div class="row mt-none-30">
                <div class="col-lg-8">
                  <div class="counter_wrap mt-30">
                    <h1><span class="number">Bs.350<span class="plus">+</span></span> <span class="text">mensual</span></h1>
                  </div>
                </div>
                
                <div class="col-lg-4">  
                  <div class="counter_wrap mt-30">
                    <h1><span class="number">Bs.50<span class="plus">+</span></span> <span class="text">una hora</span></h1>
                  </div>
                </div>
              </div>  

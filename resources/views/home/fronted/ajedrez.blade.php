...
<head>
   ...
   <!-- bootstrap css -->
   <link rel="stylesheet" href="{{ asset('assetpublic/css/bootstrap.min.css') }}">
   <!-- style css -->
   <link rel="stylesheet" href="{{ asset('assetpublic/css/style.css') }}">
   <!-- Responsive-->
   <link rel="stylesheet" href="{{ asset('assetpublic/css/responsive.css') }}">
   <link rel="stylesheet" href="{{ asset('assetpublic/css/owl.carousel.min.css') }}">
   <!-- fevicon -->
   <link rel="icon" href="{{ asset('assetpublic/images/fevicon.png') }}" type="image/gif" />
   <!-- Scrollbar Custom CSS -->
   <link rel="stylesheet" href="{{ asset('assetpublic/css/jquery.mCustomScrollbar.min.css') }}">
...
<body class="main-layout">
   <!-- loader  -->
   <div class="loader_bg">
      <div class="loader"><img src="{{ asset('assetpublic/assetpublic/images/loading.gif') }}" alt="#" /></div>
   </div>
   <!-- end loader -->
   <!-- header -->
   <header>
            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon">
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i> Escríbenos : +59171039910</a> </li>
                     </ul>
                  </div>
                  <div class="col-md-4 col-sm-4 ">
                     <a class="logo" href="#"><img src="{{ asset('assetpublic/images/logo.png') }}" alt="#" /></a>
                  </div>
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
                        <li><a href="#"><i class="fa fa-whatsapp" aria-hidden="true"></i>+59175553338</a> </li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-7 col-lg-7">
               <div class="text-bg">
                  <h1>Descubre el <br>Fascinante Mundo del Ajedrez con ITE</h1>
                  <span>Clases de Ajedrez para Todos</span>
                  <p>Únete a nuestras clases de ajedrez y mejora tu juego con instructores expertos.¡Aprende y diviértete mientras te conviertes en un maestro del ajedrez!</p>
               </div>
            </div>
            <div class="col-md-5 col-lg-5">
               <div class="ban_img">
                  <figure><img src="{{ asset('assetpublic/images/ba_ing.png') }}" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-12 col-lg-5">
               <div class="about_img">
                  <figure><img src="{{ asset('assetpublic/images/about_img2.jpg') }}" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="{{ asset('assetpublic/images/service_icon1.png') }}" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="{{ asset('assetpublic/images/service_icon2.png') }}" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="{{ asset('assetpublic/images/service_icon3.png') }}" alt="#" />
                  <h3>DIGITAL marketing</h3>
                  <p>Lorem Ipsum is simply dummy text of the printing and1500s, </p>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="{{ asset('assetpublic/images/service_icon4.png') }}" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="{{ asset('assetpublic/images/service_icon5.png') }}" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="{{ asset('assetpublic/images/service_icon6.png') }}" alt="#" />
                  <h3>UX RESEARCH</h3>
                  <p>Lorem Ipsum is simply dummy text of the printing and1500s, </p>
               </div>
            </div>
                     ...
                     <div class="row">
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="{{ asset('assetpublic/images/potf1.jpg') }}" alt="#" />
                              <div class="middle">
                        ...
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="{{ asset('assetpublic/images/potf2.jpg') }}" alt="#" />
                              <div class="middle">
                                 <div class="text2">View More</div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="{{ asset('assetpublic/images/potf3.jpg') }}" alt="#" />
                              <div class="middle">
                                 <div class="text2">View More</div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="{{ asset('assetpublic/images/potf4.jpg') }}" alt="#" />
                              <div class="middle">
                                 <div class="text2">View More</div>
                              </div>
                           </div>
         ...
         <div class="row">
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="{{ asset('assetpublic/images/business_icon1.png') }}" alt="#" /></i>
                  <h3>23</h3>
                  <p>NOMINATIONS </p>
               </div>
            </div>
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="{{ asset('assetpublic/images/business_icon2.png') }}" alt="#" /></i>
                  <h3>31</h3>
                  <p>AGENCIES</p>
               </div>
            </div>
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="{{ asset('assetpublic/images/business_icon3.png') }}" alt="#" /></i>
                  <h3>7</h3>
                  <p>AWARDS</p>
               </div>
            </div>
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="{{ asset('assetpublic/images/business_icon4.png') }}" alt="#" /></i>
                  <h3>8</h3>
                  <p>Supported </p>
               </div>
            </div>
                              ...
                              <div class="row">
                                 <div class="col-md-4 col-sm-6">
                                    <div id="ho_bg" class="team_img">
                                       <img src="{{ asset('assetpublic/images/team1.png') }}" alt="#" />
                                       <div class="ho_socal">
                                 ...
                                 <div class="col-md-4 col-sm-6">
                                    <div id="ho_bg" class="team_img">
                                       <img src="{{ asset('assetpublic/images/team2.png') }}" alt="#" />
                                       <div class="ho_socal">
                                          <ul class="social_icont">
                                             <li> <a href="#"><i class="fa fa-facebook-f"></i></a></li>
                                             <li> <a href="#"><i class="fa fa-twitter"></i></a></li>
                                 ...
                                 <div class="col-md-4 col-sm-6 d_none1">
                                    <div id="ho_bg" class="team_img ">
                                       <img src="{{ asset('assetpublic/images/team3.png') }}" alt="#" />
                                       <div class="ho_socal">
                                          <ul class="social_icont">
                                             <li> <a href="#"><i class="fa fa-facebook-f"></i></a></li>
                                             <li> <a href="#"><i class="fa fa-twitter"></i></a></li>
                     ...
                     <div class="row">
                        <div class="col-md-6 offset-md-3">
                           <div class="test_box">
                              ...
                              <i><img src="{{ asset('assetpublic/images/cos.jpg') }}" alt="#" /></i> <span>Consectetur</span>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <footer>
      <div class="footer">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <a class="logo2" href="#"><img src="{{ asset('assetpublic/images/loogo2.png') }}" alt="#" /></a>
               </div>
   ...
   <!-- end footer -->
   <!-- Javascript files-->
   <script src="{{ asset('assetpublic/js/jquery.min.js') }}"></script>
   <script src="{{ asset('assetpublic/js/popper.min.js') }}"></script>
   <script src="{{ asset('assetpublic/js/bootstrap.bundle.min.js') }}"></script>
   <script src="{{ asset('assetpublic/js/jquery-3.0.0.min.js') }}"></script>
   <script src="{{ asset('assetpublic/js/owl.carousel.min.js') }}"></script>
   <!-- sidebar -->
   <script src="{{ asset('assetpublic/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
   <script src="{{ asset('assetpublic/js/custom.js') }}"></script>
</body>

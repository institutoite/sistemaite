          ...
          <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column">
              ...
              <div class="sec-title">
                ...
                <h2>El <span>ajedrez</span> es el arte de planear con antelación</h2>
                <div class="text">La vida es como el ajedrez cada decisión que tomas es una jugada que define tu futuro.</div>
              </div>

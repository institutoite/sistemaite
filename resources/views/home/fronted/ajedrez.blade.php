		...
		<div class="rev_slider_wrapper fullwidthbanner-container"  id="rev_slider_one_wrapper" data-source="gallery">
			<div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
				<ul>
					...
					<li data-transition="fadefromleft" data-description="Slide Description"  data-index="rs-1688" data-slotamount="default" data-thumb="{{ asset('assetshome/images/main-slider/ajedrezportada.jpg')}}" data-title="Slide Title">
					<img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="{{ asset('assetshome/images/main-slider/ajedrezportada.jpg')}}"> 
					...
					<li data-transition="fadefromleft" data-description="Slide Description"  data-index="rs-1689" data-slotamount="default" data-thumb="{{ asset('assetshome/images/main-slider/ajedrezportada.jpg')}}" data-title="Slide Title">
					<img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="{{ asset('assetshome/images/main-slider/ajedrezportada.jpg')}}">
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						<!-- Sec Title -->
						<div class="sec-title">
							<div class="title style-two">Curso de Ajedrez</div>
              <h2>Cada decisión que tomes es una jugada que define <span>tu futuro.!!</span></h2>
							<div class="text">¡Bienvenidos al curso de ajedrez de ITE! Estamos muy contentos de ofrecer este curso a todos los que quieran
              aprender y mejorar su juego. En este curso, aprenderás los conceptos básicos del ajedrez y cómo usarlos para mejorar
              tu habilidad en el juego. 
              También tendrás la oportunidad de practicar tus habilidades con otros 
              jugadores del curso y experimentar con diferentes estrategias. <br>
              Estamos seguros de que al final del curso, tendrás una mejor 
              comprensión del ajedrez y una mayor confianza en tu propio juego. </div>
						</div>
						<!-- Employe Box -->
        ...
        <!-- Images Column -->
				<div class="content-column col-lg-4 col-md-12 col-sm-12">
                  ...
                  <ul class="experiance_list mt-30">
                    <h2>Indice</h2>
                      <li>Como se mueven las piezas</li>
                      <li>Jugar la partida</li>
                      <li>Principios basicos de la apertura</li>
                      <li>Ganar la partida</li>
                      <li>Capturar piezas</li>
                      <li>Atacar al rey</li>
                      <li>Primeras jugadas</li>
                      <li>Consigye el maximo de tus piezas</li>
                      <li>Comprendiendo los finales</li>
                      <li>Ganar gracias a la tactica</li>
                      <li>Jugadas impositivas</li>
                      <li>Leer tablero</li>
                      <li>Aperturas clave</li>
                      <li>Elegir la mejor jugada</li>
                      <li>Activar tus piezas</li>
                      <li>Finales avazandos</li>
                      <li>Atacar al rey</li>
                      <li>Tacticas avanzadas</li>
                      <li>Patrones del final</li>
                  </ul>
	...
	<section class="process-section">
		...
		<div class="auto-container">
			...
			<div class="sec-title centered">
				<div class="title style-two">Horarios y Dias</div>
			</div>
          ...
          <div class="row">
                ...
                <aside class="sidebar sticky-top">
                  ...
                  <div class="sidebar-widget timing-widget">
                    <div class="widget-content">
                        ...
                        {{--%%%%%%%%%%%%%%%%%%%% Clases de 1:30 Hora/ Diaria %%%%%%%%%%%%%%%%%%  --}}
                        <div class="card">
                          
                          <div class="text-center">
                            <h5 class="p-3 mb-2 bg-primary text-white">Clases 1 : 30 Horas/Diaria</h5>
                          </div>
                          <div class="card-body">
              ...
              <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                <div class="experiance_item mt-30">
                  ...
                  <div class="content">
                    <h4>Opción 1</h4>
                    <p>Clases Lunes, Miércoles y Viernes</p>
                  </div>
                </div>
                <div class="experiance_item mt-30">
                  <div class="icon">
                  ...
                  <div class="content">
                    <h4>Opción 2</h4>
                    <p>Clases Martes, Jueves y Sábados</p>
                  </div>
                </div>
                <div class="experiance_item mt-30">
                  <div class="icon">
        ...
        <div class="sec-title centered">
			<div class="title style-two">Planes y Costos</div>
		</div>
          ...
          <div class="row">
              ...
              <div class="card mb-5 mb-md-0">
                <div class="card-body">
                  <div class="text-center mb-4">
                    ...
                    <h5 class="card-price">Bs.150<span class="period"> / mes</span></h5>
                  </div>
                  ...
                  <ul class="fa-ul">
                    ...
                    <li class="text-danger mb-2"><span class="fa-li"><i class="fas fa-times"></i></span>Regala conocimiento</li>
                  </ul>
              ...
              <div class="card mb-5 mb-md-0">
                <div class="card-body">
                  <div class="text-center mb-4">
                    ...
                    <h5 class="card-price">Bs.200<span class="period"> / mes</span></h5>
                  </div>
                  ...
                  <ul class="fa-ul">
                    ...
                    <li class="text-danger mb-2"><span class="fa-li"><i class="fas fa-times"></i></span>Asistente virtual ITEASY</li>
                    <li class="text-danger mb-2"><span class="fa-li"><i class="fas fa-times"></i></span>Taller de robótica</li>
                    <li class="text-secondary mb-2"><span class="fa-li"><i class="fas fa-check"></i></span>Regala conocimiento</li>
                  </ul>
              ...
              <div class="card mb-5 mb-md-0">
                <div class="card-body">
                  <div class="text-center mb-4">
                    ...
                    <h5 class="card-price">Bs.250<span class="period"> / mes</span></h5>
                  </div>
            ...
            <div class="col-md-3">
              <div class="card mb-5 mb-md-0">
                <div class="card-body">
                  <div class="text-center mb-4">
                    <h5 class="p-3 mb-2 bg-primary text-white">Plan Experto</h5>
                    <h5 class="card-price">Bs.300<span class="period"> / mes</span></h5>
                  </div>

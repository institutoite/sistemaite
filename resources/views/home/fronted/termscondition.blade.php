...
<body class="cs-dark">
  ...
  <section class="cs-page_head cs-bg" data-src="assets/img/page_head_bg.svg">
    <div class="container">
      <div class="text-center">
        <h1 class="cs-page_title">Terminos & Condiciones</h1>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url('/') }}">Inicio</a></li>
          <li class="breadcrumb-item active">Terminos & Condiciones</li>
        </ol>
      </div>
    </div>
  </section>
    ...
    <div class="row">
      <div class="col-lg-8 offset-lg-2">
        <div class="cs-single_post">
          ...
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. At possimus, repellendus nesciunt explicabo eveniet expedita quaerat, itaque placeat ipsam ullam dignissimos quidem quod! Quo nulla eum expedita repellendus unde neque.</p>
          <ul>
            <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci ea esse molestiae ipsam nemo sint quisquam dignissimos. Nam nisi commodi ipsam quia sunt natus reprehenderit, consequuntur assumenda, praesentium est nihil! </li>
            <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, eligendi architecto! Ducimus fugiat aliquid aut voluptate similique minima laborum quo modi? Cum placeat quis labore dolorum nesciunt, animi libero! Obcaecati!</li>
          </ul>
          <h3>Lorem ipsum dolor.</h3>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam laborum rerum impedit aperiam dolores. Ipsam minima nostrum similique, expedita inventore voluptas molestiae placeat atque quisquam, illo corporis aliquam magnam architecto.</p>
          <ul>
            <li>Lorem ipsum dolor sit amet</li>
            <li>BLorem ipsum dolor sit amet, consectetur adipisicing elit.</li>
            <li>Lorem ipsum dolor sit amet, consectetur.</li>
            <li>Lorem ipsum dolor sit amet, consectetur adipisicin</li>
            <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</li>
          </ul>
          <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis saepe dolores quod dolor nesciunt, molestias alias velit natus nobis. Sequi error molestias sed cupiditate ratione optio earum fugit ullam atque?</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum et, ratione odit sunt explicabo officiis odio incidunt, labore modi doloribus magni! Dignissimos necessitatibus assumenda labore dolorum, praesentium unde at id.</p>
          <h3>Lorem ipsum dolor sit amet.</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum et, ratione odit sunt explicabo officiis odio incidunt, labore modi doloribus magni! Dignissimos necessitatibus assumenda labore dolorum, praesentium unde at id. <br> Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum et, ratione odit sunt explicabo officiis odio incidunt, labore modi doloribus magni! Dignissimos necessitatibus assumenda labore dolorum, praesentium unde at id.</p>
          <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum et, ratione odit sunt explicabo officiis odio incidunt, labore modi doloribus magni! Dignissimos necessitatibus assumenda labore dolorum, praesentium unde at id.</p>
          <ul>
            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis</li>
            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit</li>
          </ul>
          <h3>Lorem ipsum dolor</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum et, ratione odit sunt explicabo officiis odio incidunt, labore modi doloribus magni! Dignissimos necessitatibus assumenda labore dolorum, praesentium unde at id.</p>

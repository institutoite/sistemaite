            ...
            <div class="blog-detail">
              <div class="inner-box">
                <div class="lower-content">
                  <p>Bienvenidos a ITE. Estos términos y condiciones establecen los términos legales que rigen su uso de nuestros servicios de formación y capacitación. Al registrarse en el Instituto, acepta estos términos y condiciones en su totalidad.</p>
								
                  <h4>Propiedad intelectual</h3>
                  <p>Todos los materiales del Instituto, incluidos los contenidos, las imágenes y los logotipos, son propiedad del Instituto o de terceros y están protegidos por las leyes de propiedad intelectual. No está permitido copiar, distribuir, modificar o utilizar los materiales del Instituto sin el consentimiento previo por escrito del Instituto.</p>
                  
                  <h4>Inscripciones</h4>
                  <p>Para inscribirse en un curso se debe completar el formulario de inscripción y proporcionar toda la información requerida. La inscripción no será confirmada hasta que el pago completo se haya recibido.</p>
    
                  <h4>Precios</h4>
                  <p>Todos los precios están sujetos a cambios sin previo aviso. El precio del curso es el que se establece en el momento de la inscripción.</p>

                  <h4>Uso del sitio web</h4>
                  <p>Al utilizar nuestro sitio web, usted acepta que no utilizará el sitio para ninguna actividad ilegal, inapropiada o engañosa. También acepta no utilizar nuestro sitio para enviar correo no deseado o cualquier otra forma de correo electrónico no solicitado.</p>
                  
                  <h4>Privacidad</h4>
                  <p>El Instituto se compromete a proteger su privacidad. No venderemos ni compartiremos su información personal con terceros, excepto según lo requiera la ley.</p>

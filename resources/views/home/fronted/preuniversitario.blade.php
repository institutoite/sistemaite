		...
		<div class="rev_slider_wrapper fullwidthbanner-container"  id="rev_slider_one_wrapper" data-source="gallery">
			<div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
				<ul>
					...
					<li data-transition="fadefromleft" data-description="Slide Description"  data-index="rs-1688" data-slotamount="default" data-thumb="{{ asset('assetshome/images/main-slider/preuniversitarioportada.jpg')}}" data-title="Slide Title">
					<img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="{{ asset('assetshome/images/main-slider/preuniversitarioportada.jpg')}}"> 
					...
					<li data-transition="fadefromleft" data-description="Slide Description"  data-index="rs-1689" data-slotamount="default" data-thumb="{{ asset('assetshome/images/main-slider/preuniversitarioportada.jpg')}}" data-title="Slide Title">
					<img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="{{ asset('assetshome/images/main-slider/preuniversitarioportada.jpg')}}">
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						<!-- Sec Title -->
						<div class="sec-title">
							<div class="title style-two">Nivel Pre-Universitario</div>
              <h2>¿Quieres que tu hijo tenga <span>éxito</span> en la Universidad?</h2>
							...
							y éxito. <br>
							En ITE, contamos con profesores altamente calificados
							que tienen experiencia en la enseñanza preuniversitaria.
							Ofrecemos una amplia variedad de cursos, todos
							diseñados para brindarte las herramientas que necesitas
							para tener éxito en la universidad. Además, nuestro
							enfoque personalizado significa que recibes atención
							individualizada para asegurarte de que puedas cumplir
							tus objetivos. <br>
              En resumen, si deseas prepararte adecuadamente para la
              universidad y mejorar tus posibilidades de éxito, el programa
              preuniversitario en ITE es la mejor opción. Ofrecemos una
              educación de calidad, profesores expertos y un enfoque
              personalizado para ayudarte a alcanzar tus objetivos y
              tener éxito en la vida. ¡Inscríbete hoy y prepárate para un 
              futuro brillante!</div>
						</div>
						<!-- Employe Box -->
						...
						<!-- End Employe Box -->
									...
									<div class="service-block col-lg-6 col-md-6 col-sm-12">
										<div class="inner-box">
											...
											<h3><a href="https://drive.google.com/file/d/1o5HKxgWk2yVav8MJRRtWynlve-8paXaK/view?usp=sharing">Visualizar Contenido Analítico</a></h3>
							...
							<div class="row clearfix">
								...
								<div class="service-block col-lg-12 col-md-6 col-sm-12">
									<div class="inner-box">
										...
										<h3><a href="{{ route('fisica') }}">Física</a></h3>
									</div>
								</div>
								...
								<div class="service-block col-lg-12 col-md-6 col-sm-12">
									<div class="inner-box">
										...
										<h3><a href="{{ route('algebra') }}">Álgebra</a></h3>
									</div>
								</div>
								...
								<div class="service-block col-lg-12 col-md-6 col-sm-12">
									<div class="inner-box">
										...
										<h3><a href="{{ route('estadistica') }}">Estadística</a></h3>
									</div>
								</div>

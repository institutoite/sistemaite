...
<body class="hidden-bar-wrapper">
  ...
  <div class="page-wrapper">
    ...
    <!-- Page Title -->
      ...
      <section class="page-title" style="background-image: url('{{ asset('assetshome/images/background/estadistica.jpg')}}');">
        <div class="auto-container">
          <h2></h2>
        ...
        <div class="row clearfix">
          ...
          <div class="content-column col-lg-7 col-md-12 col-sm-12">
            <div class="inner-column">
              <!-- Sec Title -->
              <div class="sec-title">
                <div class="title">Clases de Estadística</div>
                <h2>La <span>estadística</span> nos permite ver más allá de los números   </h2>
                <div class="text">Aprende estadística con nuestras claseas diseñadas para todos los niveles, desde principiantes hasta expertos en la materia.</div>
              </div>
              <div class="row mt-none-30">
                <div class="col-lg-6">
                  ...
                  <div class="button-box">
                    <a href="https://api.whatsapp.com/send?phone=59171039910&amp;text=Visite su pagina. Quiero mas información de las clases de estadistica" class="theme-btn btn-style-seven"><span class="txt">Contactanos <i class="flaticon-next-2"></i></span></a>
                  </div>
                </div>
                <div class="col-lg-6">

...
<body class="hidden-bar-wrapper">
  ...
  <div class="page-wrapper">
    ...
    <!-- Page Title -->
      ...
      <section class="page-title" style="background-image: url('{{ asset('assetshome/images/background/fisica.jpg')}}');">
        <div class="auto-container">
          <h2></h2>
        ...
        <div class="row clearfix">
          ...
          <div class="content-column col-lg-7 col-md-12 col-sm-12">
            <div class="inner-column">
              <!-- Sec Title -->
              <div class="sec-title">
                <div class="title">Clases de Física</div>
                <h2>Descubre el universo a través de la <span>Física</span> </h2>
                <div class="text">Ofrecemos clases de física para estudiantes de todas las edades y niveles. Nuestros profesores altamente capacitados y experimentados utilizan enfoques pedagógicos innovadores para asegurarse de que cada estudiante reciba una educación de calidad.</div>
              </div>
              <div class="row mt-none-30">
                <div class="col-lg-6">
                  ...
                  <div class="button-box">
                    <a href="https://api.whatsapp.com/send?phone=59171039910&amp;text=Visite su pagina. Quiero mas información de las clases de fisicas" class="theme-btn btn-style-seven"><span class="txt">Contactanos <i class="flaticon-next-2"></i></span></a>
                  </div>
                </div>
                <div class="col-lg-6">

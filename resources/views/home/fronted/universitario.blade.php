...
<body class="hidden-bar-wrapper">
  ...
  <div class="page-wrapper">
    ...
    <!-- Page Title -->
      <section class="page-title" style="background-image: url('{{ asset('assetshome/images/background/universitario.jpg')}}');">
          <div class="auto-container">
        <h2></h2>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          @foreach ($semana as $universitario)
                          <tr>
                            <td>{{$universitario->modalidad}}</td>
                            <td>{{$universitario->cargahoraria}} Hrs.</td>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          @foreach ($quincena as $universitario)
                          <tr>
                            <td>{{$universitario->modalidad}}</td>
                            <td>{{$universitario->cargahoraria}} Hrs.</td>
                            <td>Bs. {{$universitario->costo}} </td>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          @foreach ($bimestre as $universitario)
                          <tr>
                            <td>{{$universitario->modalidad}}</td>
                            <td>{{$universitario->cargahoraria}} Hrs.</td>
                            <td>Bs. {{$universitario->costo}} </td>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          @foreach ($trimestre as $universitario)
                          <tr>
                            <td>{{$universitario->modalidad}}</td>
                            <td>{{$universitario->cargahoraria}} Hrs.</td>
                            <td>Bs. {{$universitario->costo}} </td>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                     <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          @foreach ($modalidadesuniversitario as $modalidad)
                          <tr>
                            <td>{{$modalidad->modalidad}}</td>
                            <td>{{$modalidad->cargahoraria}} Hrs.</td>
                            <td>Bs. {{$modalidad->costo}} </td>

        ...
        <div class="row clearfix">
          ...
          <div class="content-column col-lg-7 col-md-12 col-sm-12">
            <div class="inner-column">
              <!-- Sec Title -->
              <div class="sec-title">
                <div class="title">Curso de Mantenimiento PC</div>
                <h2>Aprende a <span> solucionar</span>  problemas de hardware y software. </h2>
                <div class="text">Nuestro curso te enseñarán cómo detectar y solucionar problemas de hardware y software para que puedas tener tu computadora funcionando en optimas condiciones.</div>
              </div>
                ...
                <div class="inner-box">
                  ...
                  <div class="lower-content">
                    ...
                    <div class="blog_qoute_wrap">
                      <div class="row">
                        <div class="col-lg-6">
                          @foreach ($mantenimientocomputadoras as $mantemiento)
                          <ul class="blog_list">
                            <li>{{$mantemiento->asignatura}}</li>
                          </ul>
                          @endforeach
                        </div>

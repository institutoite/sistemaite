        ...
        <div class="row clearfix">
          ...
          <div class="content-column col-lg-7 col-md-12 col-sm-12">
            <div class="inner-column">
              <!-- Sec Title -->
              <div class="sec-title">
                <div class="title">Resolución de prácticos</div>
                <h2><span>Prácticos</span> complicados, soluciones sencillas.</h2>
                <div class="text">Si eres un estudiante o profesional que necesita ayuda para resolver prácticos de cualquier materia, estás en el lugar adecuado. Nuestro docentes estan aquí para ayudarte en todo lo que necesites, brindando soluciones detalladas y adaptadas a tus necesidades específicas. No dudes en contactarnos para cualquier duda o necesidad de ayuda.</div>
              </div>
              ...
              <div class="row mt-none-30">
                <div class="col-lg-6">
                  ...
                  <div class="button-box">
                    <a href="https://api.whatsapp.com/send?phone=59171039910&amp;text=Visite su pagina. Quiero cotizar un practico" class="theme-btn btn-style-seven"><span class="txt">Cotiza tu práctico <i class="flaticon-next-2"></i></span></a>
                  </div>
                </div>

...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9" >
        <div class="form-floating mb-3 text-gray">
            <select class="form-control @error('grado_id') is-invalid @enderror" name="grado_id" id="grado_id">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9" > 
        <div class="form-floating mb-3 text-gray">
            <select class="form-control @error('colegio_id') is-invalid @enderror" name="colegio_id" id="colegio_id">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9" >
        <div class="form-floating mb-3 text-gray">
            <select class="form-control @error('anio') is-invalid @enderror" name="anio" id="anio">

    ...
    {{-- <a href="{{route('matriculacion.show', $id)}}" class="btn-accion-tabla tooltipsC mr-1" title="Ver esta matriculación">
    ...
    <form action=""  class="d-inline formulario">
        @csrf
        @method("delete")
        <button name="btn-eliminar" id="" type="submit" class="btn eliminar" title="Eliminar esta matriculación">
            <i class="fa fa-fw fa-trash text-danger"></i>   
        </button>
    </form> 
    
    <a href="{{route('clases.marcado.generalcom',$id)}}" class="" title="Gestionar asistencia computación">

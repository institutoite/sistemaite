                    ...
                    $.ajax({
                        ...
                        success : function(json) {
                            ...
                            if(json.persona.telefono!=0){
                                $("#personal").attr('href','https://api.whatsapp.com/send?phone=591'+json.persona.telefono+'&text='+texto+"%0Awa.me/59171324941");
                    ...
                    $("#contactos").dataTable().fnDestroy();
                        tablacontactos = $('#contactos').DataTable(
                        {
                            ...
                            "createdRow": function (row, data, dataIndex) {
                                ...
                                $('td', row).eq(5).children('.cargarmensaje').attr('href','https://api.whatsapp.com/send?phone=591'+data['telefono']+'&text='+texto+"%0Awa.me/59171324941");

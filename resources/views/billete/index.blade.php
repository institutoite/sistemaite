    ...
    <div class="card">
        <div class="card-header bg-primary">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span id="card_title">
                    {{ __('Billetes Inscripciones') }}
                </span>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="billetes_inscripciones" class="table table-striped table-hover table-bordered">
                    <thead class="thead">
                        <tr>
                            <th>CORTE</th>
                            <th>CANTIDAD</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#billetes_inscripciones').dataTable({
                "responsive":true,
                "searching":true,
                "paging":   true,
                "autoWidth":false,
                ...
                "ajax":{
                        'url':"listar/billetes/inscripciones",
                        "data":{
                            fechaini:$("#fechaini").val(),
                            fechafin:$("#fechafin").val(),
                        },
            ...
            function mostrarBilletes($fechaini,$fechafin){
                ...
                $("#billetes_inscripciones").dataTable().fnDestroy();
                $('#billetes_inscripciones').dataTable({
                    "responsive":true,
                    "searching":true,
                    "paging":   true,

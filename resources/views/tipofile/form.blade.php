...
<div class="row">
        ...
        <div class="form-floating mb-3 text-gray">
            <input  type="text" name="tipofile" id="tipofile"  class="form-control @error('tipofile') is-invalid @enderror" value="" autocomplete="off">
...
<div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
        <div class="form-floating mb-3 text-gray">
            <input  type="text" name="programa" id="programa"  class="form-control @error('programa') is-invalid @enderror" value="" autocomplete="off">
